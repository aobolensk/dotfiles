...
for git_prompt in "$HOME/.git-prompt.sh" "$git_exec_path/git-sh-prompt" \
    "$git_prefix"/share/{git-core,git-core/contrib/completion,git/completion}/git-prompt.sh \
    /etc/profile.d/git-prompt.sh
do
    [ -f "$git_prompt" ] && . "$git_prompt" && break
done
unset git_exec_path git_prefix git_prompt
command -v __git_ps1 >/dev/null 2>&1 || __git_ps1() { :; }

if [ "$color_prompt" = yes ]; then
    if [ "$USER" = "root" ]; then
        PS1='\[\033[01;31m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\[\033[35m\]$(__git_ps1 "(%s)")\[\033[00m\]\$ '
    else
        PS1='\[\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\[\033[35m\]$(__git_ps1 "(%s)")\[\033[00m\]\$ '
    fi
else
